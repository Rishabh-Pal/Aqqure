...
const Hero = () => {
  ...
  if (!isMounted) {
    return (
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#0a0a0a] via-[#0f0f0f] to-[#0a0a0a] pt-16">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl" />
        </div>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center opacity-0">
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="text-base md:text-lg text-gray-400 leading-relaxed h-12 flex items-center w-full mb-4"
            >
              <RotatingText
                texts={[
            ...
            >
              <div className="flex flex-wrap gap-3 text-sm text-gray-400">
                ...
                >
                  ...
                  <span>Actionable insights on food and labor costs</span>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium text-sm overflow-hidden"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-5 py-2.5 border-2 border-gray-700 text-gray-300 rounded-lg font-medium text-sm hover:border-blue-500 hover:text-blue-400 transition-colors"
              >
          ...
          >
            <motion.div
              ...
              className="bg-[#1a1a1a] rounded-2xl border border-gray-800 shadow-2xl p-6 backdrop-blur-sm"
            >
              {/* Location Tabs */}
